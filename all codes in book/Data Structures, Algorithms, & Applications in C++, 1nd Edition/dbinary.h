...
//                         BinaryTreeNode<T> *t)
void BinaryTree<BinNode>::PreOrder(
              void(*Visit)(BinaryTreeNode<BinNode> *u),
                        BinaryTreeNode<BinNode> *t)
{// Preorder traversal.
   if (t) {Visit(t);
...
//            void(*Visit)(BinaryTreeNode<T> *u),
//                         BinaryTreeNode<T> *t)
void BinaryTree<BinNode>::InOrder(
           void(*Visit)(BinaryTreeNode<BinNode> *u),
                        BinaryTreeNode<BinNode> *t)
{// Inorder traversal.
...
//            void(*Visit)(BinaryTreeNode<T> *u),
//                         BinaryTreeNode<T> *t)
void BinaryTree<BinNode>::PostOrder(
           void(*Visit)(BinaryTreeNode<BinNode> *u),
                        BinaryTreeNode<BinNode> *t)
{// Postorder traversal.
...
//           void(*Visit)(BinaryTreeNode<T> *u))
void BinaryTree<BinNode>::LevelOrder(
          void(*Visit)(BinaryTreeNode<BinNode> *u))
